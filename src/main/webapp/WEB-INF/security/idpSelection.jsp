                ...
                <div class="post">
                    ...
                    <div class="post-body">
                        <%
                            ...
                            //System.out.println((String)PageContextImpl.proprietaryEvaluate("${requestScope}", String.class, pageContext, null));
                            //System.out.println("idpSelection.jsp: idpDiscoReturnURL="+request.getAttribute("idpDiscoReturnURL"));
                            //System.out.println("idpSelection.jsp: idp="+pageContext.getAttribute("idp"));
                        
                            String buttonValue = "Start single sign-on";
                        %>
                        <p>
